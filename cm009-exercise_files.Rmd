...
Difference between read.csv vs. read_csv: read.csv make categorical data into factor
...
tibble(let=letters,
       ...
       comb = paste(let, num)) ## paste0(let, num), remove space between number and letter
```
...
gather(lotr_untidy, key="Gender", value="Word", Female:Male)
gather(lotr_untidy, key="Gender", value="Word", contains("ale")) #both male and female, contain search many string contain "ale", not case sensitive
```
