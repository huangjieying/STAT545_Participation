...
```{r}
ggplot(iris, aes(Sepal.Width, Sepal.Length, color=factor(Petal.Length))) +
     facet_wrap(~ Species) +
     geom_point() +
     labs(x = "Sepal Width",
          y = "Sepal Length",
...
p %>% 
    ggplotly() %>% 
    htmlwidgets::saveWidget("plot.html")
```
...
What makes a plot “publication quality”? Give examples
- Labels, units
- Consistency
